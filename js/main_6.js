...
$my_global_var_counter = 0; //GLOBAL VARIABLE TO COUNT NEW PRINTER TONER ROWS -S.B., 03-04-16
...
//		newRow = "<tr><td class=\"serial_no\"><span class = \"sNo_count\">&nbsp;</span></td><td class=\"dropdown_printer_model\"><select class=\"dropdown_printer_model\" name=\"PrinterModel\"><option value=\"test1\">test1</option><option value=\"test2\">test2</option></select></td><td class=\"dropdown_toner\"><select class=\"dropdown_toner\" name=\"Toner\"><option value=\"test1\">test1</option><option value=\"test2\">test2</option></select></td><td class=\"ordering_code\" ><input type=\"textbox\" class=\"ordering_code\" name=\"OrderingCode\"></td><td class=\"quantity\"><input type=\"textbox\" class=\"quantity\" name=\"Quantity\"></td><td class=\"add\"><img src=\"images/icon-add.png\" class=\"addRowButton\"></td></tr>";
		newRow = "<tr><td class=\"serial_no\"><span class = \"sNo_count\">&nbsp;</span></td><td class=\"dropdown_printer_model\"><select  id=\" " +$temp_model +"\" class=\"dropdown_printer_model\" name=\"PrinterModel\"><option value=\"\">&nbsp;</option><option value=\"\">&nbsp;</option></select></td><td class=\"dropdown_toner\"><select id=\" " + $temp_toner +"\"  class=\"dropdown_toner\" name=\"Toner\"><option value=\"\">&nbsp;</option><option value=\"\">&nbsp;</option></select></td><td class=\"ordering_code\" ><input type=\"textbox\" class=\"ordering_code\" name=\"OrderingCode\"></td><td class=\"quantity\"><input type=\"textbox\" class=\"quantity\" name=\"Quantity\"></td><td class=\"add\"><a class=\"add_row_link\" href=\"#\"><img src=\"images/icon-add.png\" class=\"addRowButton\"></a></td></tr>";
...
$(window).load(function() {
		...
		var temp = $('.dropdown_printer_model select').val();
			$('.ordering_code').val(temp);
		});
...
//OLDEST BUT COMMENTED TO WORK ON NEW IDEA -S.B., 03-04-16
// 				 	$.each(data, function(i, item) {
// 			            //NEED TO ADD MORE OPTIONS TO DROPDOWN 
// 			            //$('.dropdown_toner').val(item.Phone);
// 			            //$('.dropdown_toner').css('background-color', '#ffffff'); 
// 			            //ADD Supply, OrderingCode
// 			                //$('#mySelect').append( new Option(text,val) );

// //			                $('.dropdown_toner').append( new Option(item.Supply,item.OrderingCode) );
// 			                $this.closest('.dropdown_toner').append( new Option(item.Supply,item.OrderingCode) );

// 						// $('.dropdown_toner').append(
// 						//         $('<option></option>').val(item.OrderingCode).html(item.Supply);

// 						//     );			            

//           				});  //end EACH
//END OLDEST BUT COMMENTED TO WORK ON NEW IDEA -S.B., 03-04-16
